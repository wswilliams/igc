    ...
    if ($_COOKIE["nome"]) {
        ...
        <html lang="en">
            <head>
                ...
                <!--<script type="text/javascript" src="js/pesquisar_mebrasia.js"></script>-->
...
<!--            </div>
     ...
     <div class="container">
       <div class="root-mastter-cabec">
           ...
           <div class="alert alert-info" role="alert"><h3>Membrasia</h3></div>
       </div>
