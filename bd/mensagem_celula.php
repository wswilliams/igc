<html>
	<head>
		...
		<title>Area de Mesagem da Celula</title>
	</head>
	<body>
				...
				<div id = "cunsulta">
                    ...
                    $achou = $_GET["ok"];
                     ...
                     if($achou == 2){
                         echo($achou);
                         echo("<br><br>");
                          echo("<center><b><h3>Operação não Realizada</h3></b></center>");
                          echo("<br>");
                          echo("<center><a href = \"celula.php\"><b><h3>Valtar</h3></b></a></center>");
                   }
                          ...
                          echo("<br><br>");
                            echo("<center><b><h3>Operação Realizada com sucesso</h3></b></center>");
                            echo("<br>");
                            echo("<center><a href = \"celula.php\"><b><h3>Valtar</h3></b></a></center>");
                          }
