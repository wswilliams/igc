...
<!--            </div>
     ...
     <div class="container">
       ...
       <div class="alert alert-info" role="alert"><h3> Aniversariante</h3></div>
       </div>
          ...
          <div class="container3">
           ...
           <div class="row">
            <div class="col-xs-6 col-md-3" id="thumb">
                <form id="pesquisarHoje" action="" method="POST">
            ...
            <div class="col-xs-6 col-md-3" id="thumb">
                <input type="image" src="ICON/internet-37197_150.png"  width="40" height="30" border="0" title = "Celula" />
              <form id="aniversarianteMes" action="" method="POST">
                  <br>
                <div class="input-group">
                    <input type="text" name="mes" class="form-control" placeholder="Escolher M&ecirc;s..." required="required">
