  ...
  <!-- Default panel contents -->
        <div class="panel-heading">
           <p id="tx-membro"> LISTA DE TODOS OS MEMBROS CADASTRADO NO SISTEMA</p>
            <a onclick="print(); return false;" href="PrintPage"><img src="bd/ICON/impressao.png" width="30" height="30" border="0" title = "Imprimir" ></a>
        </div>
          ...
          <form action = "dadosDetalhados.php" method = "post" >
                              ...
                              <tr>
                                ...
                                <td id="tx-membro" align = "center"><?php echo "<br>".$lista[$indice]->getNome(); ?></td>
                                 ...
                                 <td id="tx-membro" align = "center"><br><input type="image" src="bd/ICON/red-35780_150.png" width="30" height="20" border="0" title = "CUNSULTAR" ></td>
                              </tr>
